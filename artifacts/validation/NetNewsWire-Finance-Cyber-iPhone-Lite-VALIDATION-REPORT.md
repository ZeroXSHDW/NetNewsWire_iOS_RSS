...
| Check | Result |
|---|---:|
| Feed elements in OPML | 39 |
| Unique feed URLs | 39 |
| Duplicate URLs | 0 |
| HTTPS feed URLs | 39/39 |
| Effective URLs remain HTTPS | 39/39 |
| HTTP 200 responses | 39/39 |
| Conditional 304 responses reused from cache | 0 |
| Successful responses including cached 304s | 39/39 |
| Feed bodies verified as RSS/XML (not JSON) | 39/39 |
| MIME labels explicitly XML/RSS/Atom | 39/39 |
| MIME-labelled HTML but verified XML body | 0 |
| Feed payload measured | 39/39 |
| Maximum accepted response body | 16.00 MB |
| Responses over maximum size | 0 |
| Total feed payload in this audit | 2.16 MB |
| Median feed payload | 17.7 KB |
| 95th-percentile feed payload | 304.1 KB |
| Compressed/wire bytes measured | 39/39 |
| Total measured wire bytes | 911.3 KB |
| 95th-percentile wire bytes | 123.0 KB |
| Feed parse time measured | 39/39 |
| Total feed parse time | 0.048 seconds |
| Slowest feed parse | 0.005 seconds |
| Feeds over mobile review threshold (256 KB) | 3 |
| Feeds over 1 MB | 0 |
| Fetches over 2 seconds | 1 |
| Slowest measured fetch | 5.88 seconds |
| Device budget configured | Yes |
| Device budget status | Pass |
| Device budget failures | 0 |
| Parseable XML documents | 39/39 |
| RSS/Atom/RSS 1.0 roots | 39/39 |
| Non-empty feed titles | 39/39 |
| Valid item URLs | 38/39 |
| Structured alert identity | 1/39 |
| Item titles with text | 983/983 |
| Feeds with all item titles valid | 39/39 |
| Item dates with valid timestamps | 983/983 |
| Feeds with all item dates valid | 39/39 |
| Feeds with all item URLs valid (exception-aware) | 39/39 |
| Item URLs with HTTP(S) links | 965/983 |
| Item URLs using HTTPS | 883/983 |
...
| Recent content, default max age 180 days | 39/39 |
| Feeds marked event-driven in OPML | 23/39 |
| Stale feeds allowed by event-driven policy | 0 |
| Recent or allowed event-driven content | 39/39 |
| Oldest detected current item | 53.9 days |
...
| Source-table rows | 39/39 |
| Source-table rows with complete metadata | 39/39 |
...
|---|---:|---|---|---|---|---:|---:|---|---:|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| NASDAQTrader.com | 200 | no | rss | yes | text/xml | 23.6 KB (small) | 3.4 KB | gzip | 0.68 | 0.001 | standard | yes | 18 | 0 | 0 | 0 | 0 | 18 | 2.3 | 0.0% | 0.0% | no |         / Sun, 16 Aug 2026 11 |
| NASDAQTrader.com | 200 | no | rss | yes | text/xml | 34.7 KB (small) | 4.7 KB | gzip | 0.49 | 0.001 | event-driven | yes | 40 | 0 | 0 | 0 | 40 | 0 | 5.6 | 0.0% | 0.0% | no |         / Sun, 16 Aug 2026 11 |
| BBC News | 200 | no | rss | yes | text/xml; charset=utf-8 | 38.0 KB (small) | 8.0 KB | gzip | 0.17 | 0.002 | standard | yes | 53 | 0 | 0 | 53 | 0 | 0 | 0.2 | 7.5% | 3.8% | no |         /         |
| Markets | 200 | no | rss | yes | text/xml; charset=utf-8 | 11.4 KB (small) | 3.7 KB | gzip | 5.88 | 0.001 | standard | yes | 25 | 0 | 0 | 25 | 0 | 0 | 0.0 | 0.0% | 0.0% | no | W/"2db0-aIFEBjJn1tAkGc+bdKS6U92HX3s" /         |
...
| News and Media | 200 | no | rss | yes | application/rss+xml | 143.8 KB (small) | 32.5 KB | gzip | 0.26 | 0.002 | event-driven | yes | 25 | 0 | 0 | 25 | 0 | 0 | 2.0 | 0.0% | 0.0% | no |         /         |
| ECB - European Central Bank | 200 | no | rss | yes | text/xml | 5.8 KB (small) | 1.5 KB | gzip | 0.20 | 0.000 | event-driven | yes | 15 | 0 | 0 | 15 | 0 | 0 | 3.1 | 0.0% | 0.0% | no |         / Fri, 14 Aug 2026 12 |
| European Banking Authority | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 11.2 KB (small) | 11.2 KB |         | 0.27 | 0.000 | event-driven | yes | 10 | 0 | 0 | 10 | 0 | 0 | 10.0 | 0.0% | 0.0% | no |         /         |
| ECB - European Central Bank | 200 | no | rss | yes | text/xml | 5.9 KB (small) | 1.5 KB | gzip | 0.21 | 0.001 | event-driven | yes | 15 | 0 | 0 | 15 | 0 | 0 | 40.1 | 0.0% | 0.0% | no |         / Tue, 07 Jul 2026 08 |
| Authority for Anti-Money Laundering and Countering the Financing of Terrorism \| News articles | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 39.6 KB (small) | 5.6 KB | gzip | 0.10 | 0.001 | event-driven | yes | 30 | 0 | 0 | 30 | 0 | 0 | 10.2 | 0.0% | 0.0% | no |         /         |
| News | 200 | no | rss | yes | text/xml; charset=utf-8 | 24.6 KB (small) | 6.5 KB | gzip | 0.18 | 0.001 | event-driven | yes | 50 | 0 | 0 | 50 | 0 | 0 | 4.9 | 0.0% | 0.0% | no |         /         |
| News and communications from HM Treasury (HMT) | 200 | no | feed | yes | application/atom+xml; charset=utf-8 | 12.6 KB (small) | 12.6 KB |         | 0.14 | 0.001 | event-driven | yes | 20 | 0 | 0 | 20 | 0 | 0 | 9.1 | 0.0% | 0.0% | no | W/"7913ee7c3ce8674aaf03d62f49ba9432" /         |
| FRB: Press Release - Monetary Policy | 200 | no | rss | yes | text/xml | 9.4 KB (small) | 0.9 KB | gzip | 1.31 | 0.001 | event-driven | yes | 15 | 0 | 0 | 15 | 0 | 0 | 17.7 | 26.7% | 0.0% | no | W/"e950b61b841fdd1 / Wed, 29 Jul 2026 18 |
| Press Releases | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 17.7 KB (small) | 5.0 KB | gzip | 0.17 | 0.001 | event-driven | yes | 25 | 0 | 0 | 25 | 0 | 0 | 1.6 | 0.0% | 0.0% | no | "1786878577" / Sun, 16 Aug 2026 11 |
| Press Releases | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 4.6 KB (small) | 1.2 KB | gzip | 0.14 | 0.001 | event-driven | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.9 | 0.0% | 0.0% | no | W/"1786855736" / Sun, 16 Aug 2026 04 |
| Press Releases | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 4.4 KB (small) | 1.1 KB | gzip | 0.17 | 0.000 | event-driven | yes | 10 | 0 | 0 | 10 | 0 | 0 | 4.7 | 0.0% | 0.0% | no | W/"1786842603" / Sun, 16 Aug 2026 01 |
| ECB - Monetary policy tender operations and ad-hoc communications | 200 | no | rss | yes | application/rss+xml | 11.4 KB (small) | 1.1 KB | gzip | 0.16 | 0.001 | event-driven | yes | 32 | 0 | 0 | 0 | 32 | 0 | 4.1 | 0.0% | 0.0% | no | "myra-41883164" /         |
| FRB: Speeches | 200 | no | rss | yes | text/xml | 9.5 KB (small) | 1.7 KB | gzip | 0.12 | 0.001 | event-driven | yes | 15 | 0 | 0 | 15 | 0 | 0 | 10.6 | 0.0% | 0.0% | no | W/"db4d36b91525dd1 / Wed, 05 Aug 2026 20 |
| ECB \| US dollar (USD) - Euro foreign exchange reference rates | 200 | no | rdf:RDF | yes | application/rss+xml | 7.1 KB (small) | 1.2 KB | gzip | 0.17 | 0.000 | standard | yes | 5 | 0 | 0 | 0 | 5 | 0 | 1.9 | 0.0% | 0.0% | no | "myra-9a9d2f8d" /         |
| ECB \| Pound sterling (GBP) - Euro foreign exchange reference rates | 200 | no | rdf:RDF | yes | application/rss+xml | 7.2 KB (small) | 1.2 KB | gzip | 0.15 | 0.000 | standard | yes | 5 | 0 | 0 | 0 | 5 | 0 | 1.9 | 0.0% | 0.0% | no | "myra-676d167b" /         |
| ONS Release Calendar RSS Feed. | 200 | no | rss | yes | application/rss+xml | 5.7 KB (small) | 1.5 KB | gzip | 0.16 | 0.000 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.1 | 0.0% | 0.0% | no |         / Sun, 16 Aug 2026 11 |
| Financial Conduct Authority (FCA) | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 58.7 KB (small) | 5.4 KB | gzip | 0.12 | 0.005 | event-driven | yes | 20 | 0 | 0 | 20 | 0 | 0 | 1.8 | 0.0% | 0.0% | no | W/"1786860941" / Sun, 16 Aug 2026 06 |
| Office of Financial Sanctions Implementation | 200 | no | feed | yes | application/atom+xml; charset=UTF-8 | 97.5 KB (small) | 97.5 KB |         | 0.14 | 0.001 | event-driven | yes | 10 | 0 | 0 | 10 | 0 | 0 | 53.9 | 0.0% | 0.0% | no | "9d4467bd806020319f01466daffe2c1e" / Wed, 24 Jun 2026 11 |
...
| All CISA Advisories | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 496.4 KB (review) | 59.5 KB | gzip | 0.21 | 0.005 | event-driven | yes | 30 | 0 | 0 | 30 | 0 | 0 | 3.0 | 16.7% | 0.0% | no |         /         |
| Latest publications of type Security Advisories | 200 | no | rss | yes | text/xml; charset=utf-8 | 9.1 KB (small) | 9.1 KB |         | 0.27 | 0.001 | event-driven | yes | 10 | 0 | 0 | 10 | 0 | 0 | 24.1 | 0.0% | 0.0% | no |         /         |
| CERT-FR | 200 | no | rss | yes | application/xml | 25.5 KB (small) | 25.5 KB |         | 0.11 | 0.001 | event-driven | yes | 40 | 0 | 0 | 40 | 0 | 0 | 25.5 | 0.0% | 0.0% | no | "0be3967825899f6c231265373e818eda" / Fri, 14 Aug 2026 13 |
| News Feed | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 11.9 KB (small) | 2.9 KB | gzip | 0.13 | 0.001 | standard | yes | 20 | 0 | 0 | 20 | 0 | 0 | 12.0 | 0.0% | 0.0% | no | W/"1786716944" / Fri, 14 Aug 2026 14 |
| All Feed | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 11.2 KB (small) | 2.9 KB | gzip | 0.12 | 0.001 | event-driven | yes | 20 | 0 | 0 | 20 | 0 | 0 | 3.0 | 0.0% | 0.0% | no | W/"1786716704" / Fri, 14 Aug 2026 14 |
| BleepingComputer | 200 | no | rss | yes | text/xml; charset=utf-8 | 12.7 KB (small) | 3.2 KB | gzip | 0.11 | 0.001 | standard | yes | 15 | 0 | 0 | 15 | 0 | 0 | 0.9 | 0.0% | 0.0% | no | f15347c8d91c7f54f02bb8dcb3dea873 / Sun, 16 Aug 2026 11 |
| Krebs on Security | 200 | no | rss | yes | application/rss+xml; charset=UTF-8 | 123.0 KB (small) | 123.0 KB | gzip   | 0.16 | 0.002 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.0 | 0.0% | 0.0% | no |         / Fri, 14 Aug 2026 11 |
| CyberScoop | 200 | no | rss | yes | application/rss+xml; charset=UTF-8 | 66.1 KB (small) | 21.9 KB | gzip | 0.10 | 0.001 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.5 | 0.0% | 0.0% | no | W/"1f39778779f5d97122e2057c3c8820d5" / Thu, 13 Aug 2026 22 |
| The Record from Recorded Future News | 200 | no | rss | yes | text/xml | 5.2 KB (small) | 1.6 KB | gzip | 0.21 | 0.000 | standard | yes | 5 | 0 | 0 | 5 | 0 | 0 | 1.6 | 0.0% | 0.0% | no |         /         |
| SANS Internet Storm Center, InfoCON: green | 200 | no | rss | yes | text/xml; charset=utf-8 | 8.7 KB (small) | 2.4 KB | gzip | 0.60 | 0.000 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.4 | 0.0% | 0.0% | no | W/"22b5-6592814b55425" / Sun, 16 Aug 2026 11 |
| CERT Recently Published Vulnerability Notes | 200 | no | feed | yes | application/atom+xml; charset=utf-8 | 164.9 KB (small) | 164.9 KB |         | 0.20 | 0.002 | event-driven | yes | 15 | 0 | 0 | 15 | 0 | 0 | 4.8 | 0.0% | 0.0% | no |         / Fri, 14 Aug 2026 14 |
| Cybersecurity Insights | 200 | no | rss | yes | application/rss+xml; charset=utf-8 | 42.3 KB (small) | 11.1 KB | gzip | 0.88 | 0.001 | event-driven | yes | 40 | 0 | 0 | 40 | 0 | 0 | 4.0 | 20.0% | 0.0% | no | "1786871446-gzip" / Sun, 16 Aug 2026 09 |
| Microsoft Security Blog | 200 | no | rss | yes | application/rss+xml; charset=UTF-8 | 304.1 KB (review) | 78.9 KB | gzip | 0.27 | 0.003 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 5.8 | 0.0% | 0.0% | no | "c8f0c308c3fb485beed7fba1ccf23b95-gzip" / Fri, 14 Aug 2026 15 |
| Unit 42 | 200 | no | feed | yes | application/atom+xml; charset=UTF-8 | 23.7 KB (small) | 23.7 KB |         | 0.17 | 0.001 | standard | yes | 15 | 0 | 0 | 15 | 0 | 0 | 5.0 | 0.0% | 0.0% | no | "e4a53e9a8ba0a587ae382a50355d14d7" / Fri, 14 Aug 2026 19 |
| The latest security news for developers - The GitHub Blog | 200 | no | rss | yes | application/rss+xml; charset=UTF-8 | 174.9 KB (small) | 46.5 KB | gzip | 0.14 | 0.002 | standard | yes | 10 | 0 | 0 | 10 | 0 | 0 | 2.8 | 0.0% | 0.0% | no | W/"0ffc969d63a81f91449cbbdf2490f590" / Fri, 14 Aug 2026 23 |
...
- **Markets** — body 11.4 KB; wire 3.7 KB; encoding `gzip`; fetch 5.88s; class `small`; cached 304 `False`.
...
Configured limits: 40 feeds, 4.00 MB total full-body payload, 600.0 KB per feed, 6 mobile-review feeds and 4 interrupting notification feeds.
